...
## UPDATE: This fix has been implemented into the main Linux kernel starting with 7.0.13. Bazzite stable moved to 7.1.3 on July 14th of 2026, making this release unnecessary. I advise suing brh to move to the stable branch.

Type `brh` in terminal, select rebase, and go through the options to move to the release/branch desired. Once finished just reboot and you should be good to go!
